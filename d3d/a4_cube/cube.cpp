...
Cube::Cube(LPDIRECT3DDEVICE9 lpd3dd)
{
	this->lpd3dd = lpd3dd;

	lpd3dd->CreateVertexBuffer(
		24 * sizeof(Vertex), D3DUSAGE_WRITEONLY, Vertex::FVF, D3DPOOL_MANAGED, &lpd3dvb, NULL
	);
	...
	lpd3dd->CreateIndexBuffer(
		36 * sizeof(WORD), D3DUSAGE_WRITEONLY, D3DFMT_INDEX16, D3DPOOL_MANAGED, &lpd3dib, NULL
	);

	WORD* i = NULL;
	lpd3dib->Lock(0, 0, (VOID**)&i, 0);
...
BOOL Cube::draw(LPD3DXMATRIX lpworld, D3DMATERIAL9* lpmtrl, LPDIRECT3DTEXTURE9 lptex)
{
	if(lpworld != NULL)
	{
		lpd3dd->SetTransform(D3DTS_WORLD, lpworld);
	}
	if(lpmtrl != NULL)
	{
