...
test1Doc.h，test1Doc.cpp - 文档
这些文件包含 Ctest1Doc 类。编辑这些文件可以添加特殊文档数据并可实现文件保存和加载(通过 Ctest1Doc::Serialize)。

test1View.h，test1View.cpp - 文档的视图
这些文件包含 Ctest1View 类。
Ctest1View 对象用于查看 Ctest1Doc 对象。
