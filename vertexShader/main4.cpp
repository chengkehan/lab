...
BOOL jcd3d::jcd3d_setup()
{
	...
	xVerifyFailedIf(D3DXCompileShaderFromFileA("testVS3.vs", NULL, NULL, "Main", "vs_1_1", D3DXSHADER_ENABLE_BACKWARDS_COMPATIBILITY, &lpShader, &lpError, &lpVertexShaderConstantTable))xVerifyFailedEndIf
		if(lpError != NULL)
		{
